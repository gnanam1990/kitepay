...
export function SiteHeader({ network, onToggleNetwork }: SiteHeaderProps) {
  return (
    <header className="sticky top-0 z-40 w-full border-b border-kite-border bg-kite-bg/95 backdrop-blur-sm transition-colors duration-200">
