...
export function LinkShareCard({
  ...
  const tweetText = `Pay me ${amountLabel} ${symbol} for ${title}: ${url}`;
  ...
  return (
    <div className="w-full max-w-xl mx-auto bg-kite-card border border-kite-border rounded-2xl p-6 sm:p-10 shadow-sm">
      <div className="flex items-center gap-2 text-kite-accent mb-4">
        ...
        <h1 className="text-xl sm:text-2xl font-bold tracking-tight">Your payment link is ready</h1>
      </div>

      <p className="text-sm text-kite-fg/70 mb-6">
        Share this URL with whoever should pay you. Anyone with a Kite-compatible wallet can pay it.
      </p>
